 ...
 */
const onShowOpenDialog = async (event, options) => {
 ...
 */
const onShowSaveDialog = async (event, options) => {
  const win = BrowserWindow.fromWebContents(event.sender)
  if (win) {
 ...
 */
const onShowMessageBox = async (event, options) => {
  const win = BrowserWindow.fromWebContents(event.sender)
  if (win) {
 ...
 */
const onShowURL = async (event, url) => {
